...
function createDemoEnrichedProducts(attributes: any, photoAnalysis: any): EnrichedProduct[] {
  ...
  if (!attributes.category || attributes.category === 'chaise' || 
    ...
    demoProducts.push({
      ...
      title: 'Chaise AVINA - Beige tissu effet lin avec pieds métal noir',
      description: 'Chaise moderne AVINA en tissu effet lin beige avec pieds métal noir mat. Design épuré contemporain, assise rembourrée confortable, dossier ergonomique. Parfaite pour salon ou salle à manger. Dimensions: 45x52x82cm. Structure solide garantie 2 ans.',
      price: 79,
      compare_at_price: 99,
      category: 'Chaise',
      subcategory: 'Chaise de salle à manger moderne en tissu effet lin beige avec pieds métal noir mat',
      color: 'beige',
      material: 'tissu effet lin',
      fabric: 'tissu effet lin',
      style: 'moderne',
      dimensions: 'L:45cm x l:52cm x H:82cm',
      room: 'salon',
      image_url: 'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg',
      product_url: '#chaise-avina',
      stock_qty: 96,
      tags: ['chaise', 'avina', 'tissu effet lin', 'métal noir', 'moderne', 'beige', 'salon', 'salle à manger', 'ergonomique', 'confortable'],
      seo_title: 'Chaise AVINA Beige - Tissu effet lin avec pieds métal noir moderne',
      seo_description: 'Chaise AVINA moderne en tissu effet lin beige avec pieds métal noir. Design épuré, assise confortable, parfaite salon.',
      brand: 'Decora Home',
      confidence_score: 95,
      variants: [
        {
          id: 'avina-beige',
          title: 'Beige tissu effet lin',
          color: 'beige',
          price: 79,
          compare_at_price: 99,
          image_url: 'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg',
        ...
        {
          id: 'avina-gris',
          title: 'Gris clair tissu effet lin',
          color: 'gris',
          price: 79,
          compare_at_price: 99,
        ...
        {
          id: 'avina-anthracite',
          title: 'Anthracite tissu effet lin',
          color: 'anthracite',
          price: 79,
          compare_at_price: 99,
  ...
  if (!attributes.category || attributes.category === 'table' || 
    ...
    demoProducts.push({
      ...
      title: 'Table basse LINA - Chêne clair massif design scandinave ronde',
      description: 'Table basse ronde LINA en chêne clair massif avec plateau épuré et pieds fuselés. Design scandinave authentique, finition naturelle huilée. Dimensions: Ø90x40cm. Parfaite pour salon moderne, style nordique.',
      price: 89,
      compare_at_price: 119,
      category: 'Table',
      subcategory: 'Table basse ronde scandinave en chêne clair massif avec pieds fuselés',
      color: 'chêne clair',
      material: 'chêne massif',
      fabric: '',
      style: 'scandinave',
      dimensions: 'Ø:90cm x H:40cm',
      room: 'salon',
      image_url: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg',
      product_url: '#table-lina',
      stock_qty: 45,
      tags: ['table basse', 'lina', 'chêne clair', 'scandinave', 'ronde', 'salon', 'naturel', 'épuré', 'massif', 'nordique'],
      seo_title: 'Table basse LINA ronde - Chêne clair massif design scandinave',
      seo_description: 'Table basse LINA ronde en chêne clair massif. Design scandinave avec pieds fuselés. Finition naturelle huilée.',
      brand: 'Decora Home',
      confidence_score: 92,
      variants: [
        {
          id: 'lina-chene-clair',
          title: 'Chêne clair massif',
          color: 'chêne clair',
          price: 89,
          compare_at_price: 119,
          image_url: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg',
  ...
  if (!attributes.category || attributes.category === 'table' || 
    ...
    demoProducts.push({
      ...
      title: 'Table basse NOA - Verre trempé transparent et métal noir rectangulaire',
      description: 'Table basse rectangulaire NOA en verre trempé transparent 8mm avec structure métal noir mat. Design moderne aérien, parfaite salon contemporain. Dimensions: 100x50x35cm. Verre sécurisé anti-casse.',
      price: 79,
      compare_at_price: 109,
      category: 'Table',
      subcategory: 'Table basse rectangulaire moderne en verre trempé transparent avec structure métal noir',
      color: 'transparent',
      material: 'verre trempé',
      fabric: '',
      style: 'moderne',
      dimensions: 'L:100cm x l:50cm x H:35cm',
      room: 'salon',
      image_url: 'https://images.pexels.com/photos/1866149/pexels-photo-1866149.jpeg',
      product_url: '#table-noa',
      stock_qty: 32,
      tags: ['table basse', 'noa', 'verre trempé', 'métal noir', 'moderne', 'rectangulaire', 'salon', 'aérien', 'transparent', 'contemporain'],
      seo_title: 'Table basse NOA rectangulaire - Verre trempé et métal noir moderne',
      seo_description: 'Table basse NOA rectangulaire en verre trempé transparent avec métal noir. Design moderne aérien salon.',
      brand: 'Decora Home',
      confidence_score: 90,
      variants: [
        {
          id: 'noa-verre-noir',
          title: 'Verre trempé + Métal noir',
          color: 'transparent',
          price: 79,
          compare_at_price: 109,
          image_url: 'https://images.pexels.com/photos/1866149/pexels-photo-1866149.jpeg',
