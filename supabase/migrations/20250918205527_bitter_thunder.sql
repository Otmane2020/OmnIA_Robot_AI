/*
  # Enrichissement du catalogue produits avec IA

  1. Nouveaux champs d'enrichissement
    - Classification et attributs (category, subcategory, tags)
    - Caractéristiques physiques (color, material, fabric, style, room, dimensions)
    - Marketing (seo_title, seo_description, ad_headline, ad_description)
    - Google Shopping (google_product_category, gtin, brand)
    - Métadonnées techniques (confidence_score, enriched_at, enrichment_source)

  2. Contraintes de validation
    - Score de confiance entre 0 et 100
    - Longueurs maximales pour SEO et publicités

  3. Index de performance
    - Index sur catégories et attributs
    - Index GIN pour tags
...
-- Index de recherche textuelle simple (sans fonction complexe)
