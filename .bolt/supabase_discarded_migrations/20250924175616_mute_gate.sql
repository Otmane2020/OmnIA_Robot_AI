/*
  # Create products_enriched table with comprehensive AI attributes
...
-- Create policy for retailer-specific access
CREATE POLICY "Users can access their retailer products"
  ON products_enriched
  FOR ALL
  TO authenticated
  USING (retailer_id = current_setting('app.current_retailer_id', true));
