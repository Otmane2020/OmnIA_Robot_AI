...
-      console.log('📦 Produits catalogue trouvés:', catalogProducts.length);
...
-          console.log(`✅ Produit enrichi: ${enriched.title.substring(0, 30)}`);
...
-      // Pas de finally ici pour éviter de masquer les résultats
+      setIsSyncing(false);
+      setSyncProgress(0);
     }
   };
...
-            )}
-            {isEnriching ? 'Enrichissement...' : 'Enrichir tout'}
-          </button>
+          {!isEnriching ? (
+            <button
+              onClick={handleEnrichAll}
