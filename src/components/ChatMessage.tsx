        ...
        >
          ...
          {!message.isUser && onSpeak && (
            <button
              ...
              className="mt-3 inline-flex items-center gap-2 px-3 md:px-4 py-2 rounded-xl bg-blue-100 text-blue-700 hover:bg-blue-200 transition-all text-sm font-medium border border-blue-200 hover:scale-105 shadow-lg hover:shadow-blue-200/50"
            >
