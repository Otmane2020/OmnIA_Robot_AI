            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/20 shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative">
                  <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl border border-cyan-400/30">
                    <img 
                      src="/hero-robot-n2yJFfiH.jpg" 
                      alt="Robot OmnIA dans un showroom moderne"
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent">
                      <div className="absolute bottom-4 left-4 right-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-black/60 backdrop-blur-xl rounded-xl p-3 border border-cyan-400/50">
                            <div className="text-2xl font-bold text-cyan-400">24/7</div>
                            <div className="text-white text-sm">Disponible</div>
                          </div>
                          <div className="bg-black/60 backdrop-blur-xl rounded-xl p-3 border border-cyan-400/50">
                            <div className="text-2xl font-bold text-cyan-400">1M+</div>
                            <div className="text-white text-sm">Conversations</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed">
                      OmnIA analyse votre espace, comprend vos goûts et recommande 
                      les meubles parfaits pour votre intérieur. Intelligence artificielle 
                      avancée au service de votre décoration.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-black/20 rounded-xl p-4 border border-cyan-500/30">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-white font-semibold">IA Conversationnelle</span>
                      </div>
                      <p className="text-gray-300 text-sm">Dialogue naturel et conseils experts</p>
                    </div>
                    ...
                    <div className="bg-black/20 rounded-xl p-4 border border-purple-500/30">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-white font-semibold">Reconnaissance Vocale</span>
                      </div>
                      <p className="text-gray-300 text-sm">Parlez naturellement avec OmnIA</p>
                    </div>
                    ...
                    <div className="bg-black/20 rounded-xl p-4 border border-green-500/30">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-white font-semibold">Vente Directe</span>
                      </div>
                      <p className="text-gray-300 text-sm">Ajout panier et commande intégrés</p>
                    </div>
                    ...
                    <div className="bg-black/20 rounded-xl p-4 border border-orange-500/30">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-white font-semibold">Analytics Avancées</span>
                      </div>
                      <p className="text-gray-300 text-sm">Suivi performances et conversions</p>
                    </div>
                  </div>
                </div>
              </div>
